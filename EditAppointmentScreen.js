      ...
      <ScrollView contentContainerStyle={styles.form} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.row}>
          <View style={[styles.fieldGroup, { flex: 1 }]}>
            ...
            <View style={styles.inputBox}>
              <Ionicons name="calendar-outline" size={17} color="#94A3B8" style={styles.inputIcon} />
              <TextInput
                style={styles.input}
          ...
          <View style={[styles.fieldGroup, { flex: 1 }]}>
            ...
            <View style={styles.inputBox}>
              <Ionicons name="time-outline" size={17} color="#94A3B8" style={styles.inputIcon} />
              <TextInput
                style={styles.input}
        ...
        {/* ── Service Type ── */}
        <Text style={[styles.sectionLabel, { marginTop: 8 }]}>🩺 Service Type *</Text>
        ...
        {/* ── Status ── */}
        <Text style={[styles.sectionLabel, { marginTop: 8 }]}>📌 Booking Status</Text>
        <View style={styles.chipsWrap}>
          {STATUSES.map((s) => (
            <TouchableOpacity
              key={s}
        ...
        {/* ── Update Button ── */}
        <TouchableOpacity
          style={[styles.updateBtn, loading && { opacity: 0.75 }]}
...
const styles = StyleSheet.create({
  ...
  form: { padding: 16 },
  sectionLabel: { fontSize: 14, fontWeight: '700', color: '#475569', marginBottom: 10 },
  ...
  updateBtn: {
    backgroundColor: '#10B981', borderRadius: 16, height: 58,
